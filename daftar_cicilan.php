        ...
        <div class="container-fluid" id="main-container">
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                       <center> <h1><i class="icon-archive"></i> Daftar Cicilan</h1>
                        <h4>Cicilan</h4></center></center>
                    </div>
                </div>
                <!-- END Page Title -->
                    ...
                    <div class="span12">
                        <div class="box">
                            <div class="box-title" style="background-color: #0090ff">
                                 <h3><i class="icon-table"></i> Cicilan</h3>
                                <div class="box-tool">
    ...
    <tbody>
        <tr class="table-flag-blue">
        	<?php 
        		...
        		$sql = "SELECT * FROM cicilan";
        		$hasil = $connect->query($sql); 
        		$nomor=1; 
        	while ($isi = $hasil->fetch_array())
        	{ echo "
        	<td> $nomor</td> 
            <td>".$isi['id_cicilan']."</td>
            <td>".$isi['no_nota_jual']."</td>
            <td>".$isi['hrg_perccl']."</td>
            <td>".$isi['DP']."</td>
            <td>".$isi['jth_tmpo']."</td>
            <td>".$isi['tenor']."</td>
             </tr>";
